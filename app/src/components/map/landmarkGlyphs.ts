...
export const PINHEAD_PATHS: Record<string, string> = {
  ...
  'aid-station': 'M2 8c0-2.25 1.48-4 3.65-4c.82 0 1.55.27 2.2.7c.65-.43 1.38-.7 2.2-.7C12.22 4 14 5.75 14 8c0 2.82-1.72 5.5-4.95 5.5c-.45 0-.84-.1-1.2-.28c-.36.18-.75.28-1.2.28C3.72 13.5 2 10.82 2 8M7.85 3.55C7.56 2.2 8.35 1.18 9.6 1c.18 1.12-.47 2.2-1.75 2.55M11.65 7.1c.55.8.83 1.5.83 2.1c0 1.07-.5 1.9-1.48 2.5c-.02-1.18-.33-2.08-.93-2.7c.64-.53 1.16-1.17 1.58-1.9',
