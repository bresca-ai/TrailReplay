export const ca = {
  ...
  media: {
    ...
    videoPlacedAtPlayheadSingle: 'Aquest clip no té ubicació ni hora de gravació, així que s\'ha col·locat a la posició actual de reproducció.',
    videoPlacedAtPlayheadMultiple: '{count} clips no tenen ubicació ni hora de gravació, així que s\'han col·locat a la posició actual de reproducció.',
    videoMoveToPlayhead: 'Mou a la posició de reproducció actual',
    videoSeekTo: 'Salta a aquest clip',
    videoPlacedAtPlayheadBadge: 'Col·locat a la posició actual',
